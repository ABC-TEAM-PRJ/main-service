  ...
  return (
    ...
    <div>
      ...
      "/>
        ...
        <button className="rounded-full font-bold text-lg mb-2 border-2 border-main-color bg-white border-main-color-500 w-96 h-12 mobile:w-50 text-main-color justify-center items-stretch">네이버로 로그인</button>
        ...
        <div id='naverIdLogin' className='w-10 h-10'></div>
      </div>
      </div>
    </>
  )
